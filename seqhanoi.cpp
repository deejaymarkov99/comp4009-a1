...
char* Hanoi(int n, char* s, char* a, char* d) {
...
int main(int argc, char* argv[])
	{
		...
		Hanoi(3, s, a, d); //this is here to "get the blood pumping", on the machine I'm running this on it appears to run slower on the first call to Hanoi
